    ...
    <div class="container-fluid">
        ...
        <div class="main-header-right">
                    ...
                    <div class="dropdown nav-item d-none d-md-flex">
                        <a href="#" class="d-flex nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                            ...
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent">
                                <img src="{{ URL::asset('assets/img/flags/' . (App::getLocale() == 'en' ? 'us_flag.jpg' : (App::getLocale() == 'ar' ? 'arab_icon.png' : 'deutsch2.jpg'))) }}"
                                    alt="img">
                            </span>
                            <div class="my-auto">
                                <strong class="mr-2 ml-2 my-auto">
                                    {{ App::getLocale() == 'en' ? 'English' : (App::getLocale() == 'ar' ? 'Arabic' : 'Deutsch') }}
                                </strong>
                            </div>
                        </a>
                            ...
                            @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"
                                    ...
                                    <span class="avatar ml-3 align-self-center bg-transparent">
                                        <img src="{{ URL::asset('assets/img/flags/' . ($localeCode == 'en' ? 'us_flag.jpg' : ($localeCode == 'ar' ? 'arab_icon.png' : 'deutsch2.jpg'))) }}"
                                            alt="img">
                                    </span>
                                    <div class="d-flex">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                @can('notifications')
                    {{-- كود اجاكس لعمل ريفرش للاشعارات موجود في صفحة master --}}
                                ...
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <div class="main-notification-list Notification-scroll">
                                        <a class="d-flex p-3 border-bottom"
                                            href="{{ route('InvoicesDetails', ['id' => $notification->data['id'], 'notification_id' => $notification->id]) }}">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/faces/OIP.jfif') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ URL::asset('assets/img/faces/OIP.jfif') }}" class=""></div>
