                ...
                <div class="card-body">
                    ...
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            ...
                            {!! Form::password('password', array('class' => 'form-control', 'placeholder' => __('messages.empty_password'))) !!}
                        </div>
                    
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            <label> {{__('messages.Confirm_Password')}}:<span class="tx-danger">*</span></label>
                            {!! Form::password('confirm-password', array('class' => 'form-control', 'placeholder' => __('messages.empty_password'))) !!}
                        </div>
                    </div>
