...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{ __('dashboard.Invoices') }}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.Invoice_List') }}</span>
            </div>
        </div>
    </div>
                ...
                <div class="card-header pb-0">
                    ...
                    @can('export EXCEL')
                        <a class="modal-effect btn btn-sm btn-primary" href="{{ url('export_invoices') }}"
                            style="color:white"><i class="fas fa-file-download"></i>&nbsp;
                            {{ __('dashboard.Export_to_EXCEL') }}</a>
                    @endcan
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('InvoicesDetails', ['id' => $invoice->id, 'test']) }}"
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                <button aria-expanded="false" aria-haspopup="true"
                                                    ...
                                                    type="button">{{ __('invoices.Actions') }}<i
